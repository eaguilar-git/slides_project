...
# Overview
- Power utilities play a critical role in providing communities with reliable, high-quality electricity.
- Asset growth in utilities—reflected by increased infrastructure such as equipment and wiring—is generally seen as beneficial to advance access and service quality.
- This presentation investigates whether the recovery of operational and debt costs can help explain utility asset growth.
- The analysis indicates that, based on the available data, cost recovery does not have strong explanatory power for asset growth.
...
- We look at Average Cost Recovery (for period 2012-2022) and Annual Asset Growth Rate (for the same period) across these utilities.
...
- Only 69 out of the 189 utilities recover operation and debt costs.
- Utilities in high income and upper middle income countries, in average, recover costs, while utilities in low and low middle income do not. 
...
---
# Cost recovery and asset growth
- The ability of a utility to recover its costs (Average Cost Recovery) DOES NOT have any predictive power for how quickly its assets are growing (Total Assets Growth Rate).
- Other variables, beyond cost recovery might explain better growth in assets. 
